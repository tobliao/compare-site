...
export interface Offer {
  ...
  verificationStatus?: "verified-product-page" | "candidate-only" | "rejected";
  sourceName: string;
  sourceUrl: string;
...
export interface Product {
  ...
  trendScore?: number;
  trendKeyword?: string;
  verificationStatus?: "verified-product-page" | "candidate-only" | "insufficient-data";
  sourceUrl?: string;
